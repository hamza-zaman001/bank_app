...
import { footerLinks, socialMedia } from '../constatnts'
...
const Footer = () => (
  ...
  flex-col`}>
    ...
    border-t-[1px] border-t-[#3f3r45]'>
      <p className='font-poppins font-nomral text-center
      text-[18px] leading-[27px] text-white'>Copyright © 2021 HooBank. All Rights Reserved.</p>
      ...
      <div className='flex flex-row md:mt-0 mt-6'>
        {socialMedia.map((social, index) => (
          ...
          cursor-pointer hover:scale-150 duration-500
